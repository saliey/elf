...
public:
    ...
    Elf_Rela* plt_rel = nullptr;
    size_t plt_rel_count = 0;
	
	Elf_Rela* rela_ = nullptr;

    Elf_Rela* rel = nullptr;
    size_t rel_count = 0;
...
public:
	...
	void setFileSize(int fz, void* file) {fileSize = fz;ffd = file;}
private:
    bool RebuildPhdr();
    bool RebuildShdr();
    bool ReadSoInfo();
	...
	uint8_t * e_rebuild_data = nullptr;
